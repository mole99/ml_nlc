...
#ifndef __filter_c_top_mul_cud__HH__
#define __filter_c_top_mul_cud__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(filter_c_top_mul_cud) {
    ...
    SC_CTOR(filter_c_top_mul_cud):  ACMP_smul_su_U ("ACMP_smul_su_U") {
