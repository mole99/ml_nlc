...
#ifndef __filter_c_top_urembkb__HH__
#define __filter_c_top_urembkb__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(filter_c_top_urembkb) {
    ...
    SC_CTOR(filter_c_top_urembkb):  ACMP_urem_seq_U ("ACMP_urem_seq_U") {
