...
name = 'model_post_quant_chg'

# Fully connected weights must be transposed
...
for i, layer in enumerate(sorted_layers):
	...
	layer_output_conversion_scale = layer_bias_scale / layer_output_scale
	...
	out_file.write("\n")
	out_file.write("\t.output_conversion_scale = {},\n".format(layer_output_conversion_scale))
