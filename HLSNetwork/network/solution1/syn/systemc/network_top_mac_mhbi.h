...
// ==============================================================
#ifndef __network_top_mac_mhbi__HH__
#define __network_top_mac_mhbi__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(network_top_mac_mhbi) {
    ...
    SC_CTOR(network_top_mac_mhbi):  simcore_mac_0_U ("simcore_mac_0_U") {
