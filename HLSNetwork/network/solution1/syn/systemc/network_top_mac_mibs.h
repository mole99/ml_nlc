...
// ==============================================================
#ifndef __network_top_mac_mibs__HH__
#define __network_top_mac_mibs__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(network_top_mac_mibs) {
    ...
    SC_CTOR(network_top_mac_mibs):  simcore_mac_1_U ("simcore_mac_1_U") {
