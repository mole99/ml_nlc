...
add_files -tb network/test_data/ideal_chg.h
add_files -tb network/test_data/ideal_dchg.h -cflags "-Wno-unknown-pragmas"
add_files -tb network/network_tb.cpp -cflags "-Wno-unknown-pragmas"
